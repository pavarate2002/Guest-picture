...
//    User page  = /
//    Host page  = /host
//    Version    = /version   -> {"version":"v4.4"}
//
//  HOST buttons (all requested):
//   1) Pause / หยุดเวลา  (on Host window)
//   2) Reset All          -> ลบข้อมูลทั้งหมด
//   3) Restart Game       -> เริ่มใหม่ทั้งหมด แต่รูป+โจทย์ยังอยู่
//   4) Add row form: 1 ข้อ = 1 รูป + 3 คำถาม (ไทย/อังกฤษ/ญี่ปุ่น) ครบทุกแถว
// ============================================================
...
function freshState() {
  return { slides: [], index: 0, phase: 'idle', reveal: null };
}
...
io.on('connection', (socket) => {
  ...
  // 4) add slide = 1 image + 3 questions
  ...
  <div class="app" id="app">
    <div>
      <div class="card">
        ...
        <div class="hint">ต้องใส่ <b>รูป 1 รูป + คำถามครบทั้ง 3 แถว</b> (ไทย/อังกฤษ/ญี่ปุ่น) ถึงจะเพิ่มได้ · เก็บไว้ล่วงหน้าได้</div>
      </div>
...
<script>
  ...
  // 4) require image + all 3 questions
  function addSlide(){
