...
เกมทายภาพ real-time · แผ่น LED 4×4 · ธีมนีออน · **หน้า User แบบ 2 คอลัมน์**ไฟล์เดียวจบ ไม่มีโฟลเดอร์ public ไม่มีไฟล์ .html
...
- เช็ค = https://<app>.onrender.com/version → {"version":"v4.7"}

### Layout หน้า User
- ซ้าย: ชื่อ GUEST·PICTURE + คำถาม 3 บรรทัด (ธง ไทย→อเมริกา→ญี่ปุ่น บนลงล่าง)
- ขวา: รูปใหญ่ (เต็มกรอบ object-fit:cover) + แผ่น LED 4×4 สุ่มเปิดทุก 5 วิ

### ปุ่ม Host
- หยุดเวลา / Pause
- Reset ลบข้อมูลทั้งหมด
- Reset เริ่มเกมใหม่ (รูป+โจทย์ยังอยู่)
- เพิ่มโจทย์: 1 รูป + 3 คำถาม (บังคับครบ)
